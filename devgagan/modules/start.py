...
async def guide_command(_, message: Message):
    image_url = "https://ar-hosting.pages.dev/1752467321664.jpg"  # Direct image URL 
...
async def guide_page_1(_, query: CallbackQuery):
    await query.message.edit_text(
        "**📘 How to Use Our bot Guide 👇**\n\n"
        "💡 **For Private Channels/Groups**\n\n"
        "**How to download or forward posts from Private Channel/Groups Where Forwarding is off 💀**\n"
        "────────────────────\n"
        "➡️ Send /start\n"
        "➡️ Send /login\n"
        "────────────────────\n"
